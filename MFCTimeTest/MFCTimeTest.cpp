...
BEGIN_MESSAGE_MAP(CMFCTimeTestApp, CWinApp)
...
CMFCTimeTestApp::CMFCTimeTestApp()
{
	// 支援重新啟動管理員
...
// 唯一一個 CMFCTimeTestApp 物件

CMFCTimeTestApp theApp;


// CMFCTimeTestApp 初始化

BOOL CMFCTimeTestApp::InitInstance()
{
